    ...
    <>
      <ScrollView>
        <View style={styles.container}>
          ...
          {/* <MonthlyTotalSpending strokeWidth={25} progress={0.35} /> */}
          ...
          <View style={styles.spendingContainer}>
            <View style={{flexDirection: 'column', marginBottom: -150}}>
              {spendingData.map((spending) => (
               <>
                 <View style={{flexDirection: 'row', gap: 0}} key={spending.id}>
                  <Text style={{...styles.spendingDot, color: categoryColors[spending.category]}}>{'\u2B24'}</Text>
                  <Text style={styles.spendingText}>{spending.color}</Text>
                 </View>
               </>
              ))}
            </View>
