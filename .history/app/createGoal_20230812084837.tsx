...
const createGoal = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Pressable 
         style={{opacity: .5, backgroundColor: "green", marginHorizontal: 50, height: 50}}
         onPress={handleSaveGoal}
      >
       <Text style={{opacity: 1, textAlign: "center", alignSelf: "center", alignItems: "center", padding: 10}}>Save Goal</Text>
      </Pressable>
    </View>
  );
};
