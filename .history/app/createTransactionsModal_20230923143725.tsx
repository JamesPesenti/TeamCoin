...
export default function CreateTransactions() {
   ...
   const handleOnChangeAmount = text => setAmount(text)
   const handleOnChangeDropdown = text => setDropdown(text)
   console.log(handleOnChangeDropdown)
     ...
     <View style={styles.addGoal}>
      ...
      {amount.trim().length >= 2 ? (
         <View style={styles.buttonContainer}>
            <Pressable
               onPress={() => console.log(handleOnChangeDropdown)}
               style={styles.button}
            >
