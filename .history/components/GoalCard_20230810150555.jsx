    ...
    <>
      <View style={styles.container}>
          ...
          <DollarSign size={29} color={"gray"} />
            <View key={goals.id} style={styles.goalContainer}>
               <Text style={{ opacity: 1, fontWeight: "bold", fontSize: 20, marginBottom: 5 }}>{goals.name}</Text>
               <Text style={{ fontSize: 18 }}>{goalItem.progress} / {goals.goalAmount} saved</Text>
