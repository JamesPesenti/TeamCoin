      ...
      <View style={styles.container}>
          {/* <DollarSign style={{marginTop: -20}} size={29} color={"gray"} /> */}
            <View key={index} style={styles.goalContainer}>
               <Text style={{ opacity: 1, fontWeight: "bold", fontSize: 20, marginBottom: 5, marginRight: 10, }}>{overview.name}</Text>
               <Text style={{ margin: 20, fontSize: 22, fontWeight: "bold" ,color: "black",}}>{overview.progress}</Text>
            </View>
      </View>
    </>
  )
