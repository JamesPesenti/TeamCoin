      ...
      <View style={styles.container}>
          {/* <DollarSign style={{marginTop: -20}} size={29} color={"gray"} /> */}
            <View key={index} style={styles.goalContainer}>
               <Text style={{ opacity: 1, fontSize: 20, marginBottom: 5 }}>{overview.name}</Text>
               <Text style={{ paddingRight: 10, margin: 20, fontSize: 22, fontWeight: "bold" }}>{overview.progress}</Text>
            </View>
      </View>
    </>
  )
